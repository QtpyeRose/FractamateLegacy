   ...
   public static void main(String args[]) throws Exception{
      ...
      while(true){
         if (screen == "main") {
            ...
            start.draw();
            StdDraw.text(0.5,0.5,"FractAmate V1.0 (deriv)");
            ...
            else if (false && switchDraw.isPressed()){
               //cycle the draw type
               drawType = (drawType+1)%2;
               unpress();
            }
            else if (false && switchshowType.isPressed()){
               //cycle doShowType
            ...
            else if (false && showTypeUp.isPressed()) {
               showType+=1;
               unpress();
            } 
            else if ( false && showTypeDown.isPressed()) {
               showType-=1;
               unpress();
            ...
            //seed.draw();
            ArrayList<Vector> active = new ArrayList<Vector>();
            active.add(seed);
            ArrayList<Vector> gen = new ArrayList<Vector>();
